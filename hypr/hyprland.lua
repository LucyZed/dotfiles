...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(B10B11ee)", "rgba(FE909Bee)"}, angle = 45 },
...
hl.bind(mainMod .. " + f9", hl.dsp.exec_cmd("pkill -SIGRTMIN+3 -f \"gpu-screen-recorder\""))
hl.bind(mainMod .. " + f10", hl.dsp.exec_cmd("pkill -SIGRTMIN+4 -f \"gpu-screen-recorder\""))
...
for i = 1, 9 do -- Prebacila workspace 10 na D jer aint no one reaching for the 0 key vro :broken_heart:
    local key = i % 10
